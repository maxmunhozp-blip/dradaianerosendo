  ...
  const renderMessageContent = (msg: ChatMessage) => {
    ...
    return (
      <>
        ...
        {laraActions.length > 0 && !msg.isStreaming && <LaraActionButtons actions={laraActions} onScanComplete={(summary) => handleQuickSend(summary)} messageContent={cleanContent} allMessages={messages} contextCaseId={caseId} />}
